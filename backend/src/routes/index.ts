...
import wabaMetaOAuthRoutes from "./wabaMetaOAuthRoutes";
import wabaMetaTemplateRoutes from "./wabaMetaTemplateRoutes";
...
routes.use(wabaMetaOAuthRoutes);
routes.use(wabaMetaTemplateRoutes);
